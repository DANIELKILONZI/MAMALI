...
function NewAdPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await adminApi.advertisements.create({
        ...form,
      ...
      toast.error(err instanceof Error ? err.message : 'Failed to create advertisement');
    } finally {
  ...
  return (
    <AdminLayout>
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-900">New Advertisement</h2>
      </div>
